...
byte-compiled =init.el= by way of a kludgey bash script.

Commented-out org-mode headings are neither shown here nor present in the tangled
resulting elisp, but they are present in the repo that houses this document.
...
#+INCLUDE: "../nougat/package-management/straight.org::use-package integration" :minlevel 2
* themes
...
** solarized-theme
Solarized is a nice theme.  Easy on the eyes.
#+begin_src emacs-lisp
(use-package solarized-theme)
(load-theme 'solarized-dark t)
#+end_src

For reasons I don't fully understand, this doesn't work but ought to:
#+begin_src emacs-lisp
